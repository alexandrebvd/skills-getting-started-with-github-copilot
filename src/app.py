...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training sessions and technique improvement",
    ...
    # Artistic
    "Drama Club": {
        "description": "Acting exercises and school play productions",
    ...
    "Math Olympiad": {
        ...
        "max_participants": 16,
        "participants": ["henry@mergington.edu", "william@mergington.edu"]
    },
    "Science Club": {
